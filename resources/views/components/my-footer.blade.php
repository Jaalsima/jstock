<div>
    <div class="relative shadow-lg shadow-gray-400">
        <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2.000000, 44.000000)" fill="#9BABB8" fill-rule="nonzero">
                    <path
                ...
                <g transform="translate(-4.000000, 76.000000)" fill="#ccc" fill-rule="nonzero">
                    <path
    ...
    <footer class="text-center text-xl">
        ...
        <div class="dark:text-gray-100 focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500 text-lg">
            2023
            &copy;
        </div>
