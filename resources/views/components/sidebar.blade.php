...
<div class="flex flex-no-wrap">
    ...
    {{-- sidebar dispositvos pequeños --}}
    <div class="absolute z-40 flex-col justify-between w-64 transition duration-150 ease-in-out bg-gray-800 shadow md:h-full sm:hidden"
        id="mobile-nav">
        <button aria-label="toggle sidebar" id="openSideBar"
            class="absolute right-0 flex items-center justify-center w-10 h-10 mt-16 -mr-10 bg-gray-800 rounded rounded-tr rounded-br shadow cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
        ...
        <div class="px-8">
            ...
            <ul class="mt-12">
                <li
                    class="flex items-center justify-between w-full mb-6 text-gray-500 cursor-pointer hover:text-gray-500">
                    ...
                    <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-500 bg-gray-200 rounded">
                        5</div>
                </li>
                <li
                ...
                <li
                    ...
                    <a href="javascript:void(0)"
                        ...
                        <span class="ml-2 text-lg">Performance</span>
                    </a>
                </li>
                <li
                    class="flex items-center justify-between w-full mb-6 text-gray-600 cursor-pointer hover:text-gray-500">
                ...
                <li class="flex items-center justify-between w-full text-gray-600 cursor-pointer hover:text-gray-500">
                    <a href="javascript:void(0)"
                        class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <ul class="flex items-center justify-between w-full bg-gray-800">
                <li class="pt-5 pb-3 text-white cursor-pointer">
                    <button aria-label="show notifications"
                        class="rounded focus:outline-none focus:ring-2 focus:ring-gray-300">
