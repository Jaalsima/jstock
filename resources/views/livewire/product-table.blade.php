<div>
    ...
    <div class="flex ml-4">
        <input type="text" wire:model="search" class="w-1/4 mr-4 bg-white border-none rounded-lg focus:ring-gray-400"
            placeholder="Buscar...">
        <livewire:create-product class="" />
    </div>
</div>
<div class="relative mt-4 overflow-x-auto shadow-md sm:rounded-lg">

    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-sm text-gray-100 uppercase bg-gray-400 dark:bg-gray-700 dark:text-gray-400">
            <tr>
            ...
            @forelse ($products as $product)
                <tr
                    ...
                    <td class="flex justify-around py-4 pl-2 pr-8">
                        ...
                        <a href="{{ route('products.destroy', $product) }}" class="text-red-600 hover:text-red-400"
