<div class="relative inline-block text-center cursor-pointer group">
    ...
    <x-dialog-modal wire:model="open">
        <x-slot name="title">
            <h2 class="mt-3 text-2xl text-center">{{ $customer->name }}</h2>
        </x-slot>
        <x-slot name="content">
            <div class="mx-auto my-2 rounded-full w-52">
                <img src="{{ asset('storage/' . $customer->image) }}" alt="Imagen de {{ $customer->name }}"
            ...
            <div class="px-5 pb-5">
                <div class="mx-6">
                    ...
                    <div class="text-lg text-start">
                        ...
                        <p><strong>Slug:</strong> {{ $customer->slug }}</p>
