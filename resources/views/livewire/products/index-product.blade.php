        ...
        <div class="flex w-full mt-2">
            <div class="ml-4 w-3/4">
                ...
                <select wire:model="categoryFilter"
                    class="w-1/11 mr-4 bg-white hover:bg-gray-400 cursor-pointer border-none rounded-lg focus:ring-gray-400">
                ...
                <button wire:click="resetFilters"
                    class="w-1/11 mr-4 bg-white hover:bg-gray-400 border-none rounded-lg focus:ring-gray-400 p-2">
                    Restablecer
                </button>
            </div>
            <div class="mr-4 w-1/4 float-right">
        ...
        <div class="relative mt-4 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="12" class="mt-64 text-5xl text-center dark:text-gray-200">Aún no se han agregado
                            productos.</td>
                    </tr>
                    @endforelse
                </tbody>
