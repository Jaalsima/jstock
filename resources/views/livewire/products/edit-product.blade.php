               ...
               <div class="w-1">
                   <x-slot name="content">
                       <form wire:submit.prevent="update" enctype="multipart/form-data">
                           ...
                           <div class="relative mt-4">
                               <label
                                   ...
                                   <div class="text-center">
                                       <span class="font-normal text-gray-600">Cambiar imagen del producto
                                           (opcional)</span>
                                   </div>
                                   ...
                                   <div class="absolute top-0 h-48 w-72">
                                       ...
                                       @else
                                           <img class="object-cover w-full h-full rounded-lg"
                                               src="{{ asset('storage/' . $product->image) }}" class="mb-4"
                                               alt="Image">
                                       @endif
                                   </div>
                               </label>
                           ...
                           <!-- Dropdown para Marca -->
                           <div class="mt-4">
                               <x-label for="brand_id" value="Marca" class="text-gray-700" />
                               <select id="brand_id" class="w-full rounded-md" wire:model.lazy="brand_id">
                           ...
                           <div class="mt-4">
                               <x-label for="category_id" value="Categoría" class="text-gray-700" />
                               <select id="category_id" class="w-full rounded-md" wire:model.lazy="category_id">
                           ...
                           <div class="mt-4">
                               ...
                               <x-input id="expiration" type="date" class="w-full"
                                   wire:model.lazy="expiration" />
                           ...
                           <div class="mt-4">
                               ...
                               <x-input id="observations" type="text" class="w-full"
                                   wire:model.lazy="observations" />
