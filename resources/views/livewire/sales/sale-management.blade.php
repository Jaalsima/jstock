<div class="p-4">
    <div class="grid grid-cols-5 gap-4">
        <div class="h-[88vh] col-span-2 p-6 bg-gray-200 rounded-lg shadow-gray-400 shadow-md">
            <h1 class="mb-10 text-2xl font-semibold text-center">Registro de Venta</h1>
        ...
        <div id="contentEval"
            ...
            <h1 class="mt-8 text-2xl font-semibold text-center">Lista de Ventas</h1>
            <!-- sale List Table -->
                    ...
                    @foreach ($sales as $sale)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap hover:text-blue-600"><a
                                    href="#">{{ $sale->customer->name }}</a></td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $sale->invoice_number }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $sale->total_amount }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $sale->created_at }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
