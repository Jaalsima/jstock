<div class="h-screen p-4 overflow-auto" style="width:196vh; height: 92vh">
    ...
    <div class="flex justify-around w-full p-4 mx-auto h-1/5">
        ...
        <div class="w-full h-full p-4 mx-2 bg-blue-300 rounded-lg">Item</div>
    ...
    <div class="my-6 bg-yellow-100">
        <table class="mx-auto bg-red-500">
            <thead class="inline-block mt-4">
                <tr>
                    <th class="inline-block px-8 py-2 mx-2 rounded-md bg-slate-300">Item thead</th>
                    <th class="inline-block px-8 py-2 mx-2 rounded-md bg-slate-300">Item thead</th>
                    <th class="inline-block px-8 py-2 mx-2 rounded-md bg-slate-300">Item thead</th>
                    <th class="inline-block px-8 py-2 mx-2 rounded-md bg-slate-300">Item thead</th>
                    <th class="inline-block px-8 py-2 mx-2 rounded-md bg-slate-300">Item thead</th>
            ...
            <tbody class="bg-gray-300">
                <tr>
                    <td class="inline-block px-8 py-2 mx-2 rounded-md">Item tbody</td>
                    <td class="inline-block px-8 py-2 mx-2 rounded-md">Item tbody</td>
                    <td class="inline-block px-8 py-2 mx-2 rounded-md">Item tbody</td>
                    <td class="inline-block px-8 py-2 mx-2 rounded-md">Item tbody</td>
                    <td class="inline-block px-8 py-2 mx-2 rounded-md">Item tbody</td>
