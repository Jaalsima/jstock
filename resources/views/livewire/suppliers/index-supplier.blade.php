<div>
    ...
    <div>
        ...
        <div class="flex">
            ...
            <input type="text" wire:model.lazy="search"
                class="w-1/4 mr-4 bg-white border-none rounded-lg focus:ring-gray-400" id="supplier_search"
                placeholder="Buscar...">
    ...
    <div class="relative mt-4 overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <!-- Check if there are suppliers before rendering the table and its header -->
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                        ...
                        <tr
                            ...
                            <td class="flex justify-around py-4 pl-2 pr-8">
                                <div
                                    ...
                                    {{-- @livewire('show-supplier', ['supplier' => $supplier], key(time() . $supplier->id))
                                          @livewire('edit-supplier', ['supplier' => $supplier], key(time() . $supplier->id)) --}}
                    ...
                    @empty
                        ...
                        <tr>
                            <td colspan="12" class="text-3xl text-center dark:text-gray-200">No hay proveedores
                                Disponibles</td>
                        </tr>
                    @endforelse
                @else
