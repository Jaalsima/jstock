        ...
        <div class="w-1">
            <x-slot name="content">
                ...
                <form>
                    ...
                    <!-- Nombre -->
                    <x-label for="create_supplier_name" value="Nombre" class="ml-3 text-gray-700" />
                    <x-input class="w-full" wire:model.lazy="name" id="create_supplier_name" />
                    <x-input-error for="create_supplier_name" />

                    <!-- Correo Electrónico -->
                    <x-label for="create_supplier_email" value="Correo Electrónico" class="ml-3 text-gray-700" />
                    <x-input class="w-full" wire:model.lazy="email" type="email" id="create_supplier_email" />
                    <x-input-error for="create_supplier_email" />

                    <!-- Dirección -->
                    <x-label for="create_supplier_address" value="Dirección" class="ml-3 text-gray-700" />
                    <x-input class="w-full" wire:model.lazy="address" id="create_supplier_address" />
                    <x-input-error for="create_supplier_address" />

                    <!-- Teléfono -->
                    <x-label for="create_supplier_phone" value="Teléfono" class="ml-3 text-gray-700" />
                    <x-input class="w-full" wire:model.lazy="phone" id="create_supplier_phone" />
                    <x-input-error for="create_supplier_phone" />

                    <!-- Dropdown para Estado -->
                    <x-label for="create_supplier_status" value="Estado" class="ml-3 text-gray-700" />
                    <select class="w-full mb-4 rounded-md" wire:model.lazy="status" id="create_supplier_status">
                        <option value="">Selecciona un estado</option>
                        <option value="Activo">Activo</option>
                        <option value="Inactivo">Inactivo</option>
                    </select>
                    <x-input-error for="create_supplier_status" />
                </form>
