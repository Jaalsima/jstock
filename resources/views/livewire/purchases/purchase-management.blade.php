<div class="container p-6 mx-auto">
    ...
    <div class="flex mb-4">
        <div class="w-1/3 mr-4">
            <label for="supplierId" class="block font-bold mb-1">Proveedor</label>
        ...
        <div class="w-1/3">
            <button wire:click="addProduct"
                class="px-4 py-2 mt-8 text-white font-semibold bg-blue-600 rounded shadow-lg hover:text-blue-900 hover:bg-blue-400 hover:shadow-blue-700">Agregar
                Producto
            </button>
        </div>
    </div>
    ...
    <div class="mb-6 overflow-x-auto">
        <table class="w-full border border-collapse border-gray-300">
            ...
            <tbody>
                ...
                <tr>
                    <td class="p-2">
                        <select wire:model="products.{{ $index }}.id" class="w-full p-2 border border-gray-300 rounded">
    ...
    <x-dialog-modal wire:model="open">
        <x-slot name="title">
            <h2 class="text-2xl text-center font-bold">Detalle de Compra</h2>
        </x-slot>
        ...
        <x-slot name="content">
            <div class="p-4">
                ...
                <div class="flex justify-end">
                    ...
                    <p class="text-2xl font-bold text-green-600">${{ number_format($selectedPurchase->total_amount, 2)
                        }}</p>
                </div>
            </div>
        </x-slot>
