<div class="my-auto">
    <x-secondary-button wire:click="$set('open', true)"
        class="text-white border border-blue-200 shadow-lg hover:shadow-blue-400">
        Nuevo
    </x-secondary-button>
    ...
    <x-dialog-modal wire:model="open">
        ...
        <div class="w-1">
            <x-slot name="content">
                ...
                <div class="relative mt-4">
                    <label
                        ...
                        <div class="text-center">
                            <span class="font-normal text-gray-600">Agrega una foto de perfil</span>
                        </div>
                        ...
                        <div class="absolute top-0 h-48 w-72">
                            @if ($profile_photo_path)
                                <img class="object-cover w-full h-full rounded-lg" src="{{ $profile_photo_path->temporaryUrl() }}"
                                    class="mb-4" alt="Foto de Perfil">
                            @endif
                        </div>
                    </label>
                </div>
                ...
                <x-input class="w-full" wire:model.lazy="email" />
                ...
                <x-input class="w-full" type="password" wire:model.lazy="password" />
        ...
        <x-slot name="footer">
            <div class="mx-auto">
                ...
                <x-secondary-button
                    ...
                    wire:click="add" wire:loading.attr="disabled" wire:target="add, profile_photo_path">
                    Agregar
                </x-secondary-button>
            </div>
        </x-slot>
