<x-home-layout>
    ...
    <div class="flex flex-col justify-between min-h-screen">
        ...
        <div class="bg-white dark:bg-gray-800 dark:text-gray-100 shadow-lg shadow-gray-400 rounded-lg w-1/2 mt-16 mx-auto p-4 text-center text-6xl text-bold text-gray-600">
            <h1>Blog JStock</h1>
        </div>
        ...
        <div class="flex w-4/5 mx-auto my-6">
            <div class="">
                <div class="pl-4 pr-12 py-4">
                    <a href="#"
                        class="w-full mt-10 h-auto flex cursor-default"  id="blog1">
                        ...
                        <div class="w-2/3 h-auto ml-12 p-4 text-justify rounded-md leading-normal bg-white dark:bg-gray-800 shadow-md shadow-gray-400">
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <div class="bg-red-500 p-1 mx-4 mb-2 float-right w-2/5 h-70 relative rounded-md">
                                ...
                                src="{{ asset('images/inventory/inventory2.png') }}" alt="Worker" class=" w-4 ">
                            </div>
                    ...
                    <a href="#"
                        class="cursor-default w-full mt-10 h-auto flex">
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <div class="bg-red-500 p-1 mx-4 mb-2 float-right w-2/5 h-70 relative rounded-md">
                                <img class="w-full h-full object-cover rounded-lg"
                                src="{{ asset('images/inventory/inventory1.png') }}" alt="Worker" class=" w-4 ">
                            </div>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-justify">Here are the biggest enterprise
                                    technology acquisitions of 2021 so far, in reverse chronological order. Lorem ipsum dolor
                                    sit
            ...
            <div class="mt-10 pt-4">
                <aside class="w-48 sticky top-10 text-white rounded-md shadow-lg shadow-red-300 p-4 text-xl bg-gray-500 dark:bg-gray-800">
